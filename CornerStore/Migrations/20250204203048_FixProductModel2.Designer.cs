...
namespace CornerStore.Migrations
{
    ...
    [Migration("20250204203048_FixProductModel2")]
    partial class FixProductModel2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CornerStore.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierId = 1,
                            PaidOnDate = new DateTime(2025, 2, 4, 14, 30, 47, 551, DateTimeKind.Local).AddTicks(6294)
                        },
                        new
                        {
                            Id = 2,
                            CashierId = 2,
                            PaidOnDate = new DateTime(2025, 2, 4, 14, 30, 47, 551, DateTimeKind.Local).AddTicks(6353)
                        });
                });
