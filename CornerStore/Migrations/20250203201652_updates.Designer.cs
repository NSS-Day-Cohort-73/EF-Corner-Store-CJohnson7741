...
namespace CornerStore.Migrations
{
    ...
    [Migration("20250203201652_updates")]
            ...
            modelBuilder.Entity("CornerStore.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierId = 1,
                            PaidOnDate = new DateTime(2025, 2, 3, 14, 16, 51, 632, DateTimeKind.Local).AddTicks(1235)
                        },
                        new
                        {
                            Id = 2,
                            CashierId = 2,
                            PaidOnDate = new DateTime(2025, 2, 3, 14, 16, 51, 632, DateTimeKind.Local).AddTicks(1292)
                        });
                });
