...
namespace CornerStore.Migrations
{
    ...
    [Migration("20250203171638_InitialCreate")]
            ...
            modelBuilder.Entity("CornerStore.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierId = 1,
                            PaidOnDate = new DateTime(2025, 2, 3, 11, 16, 38, 76, DateTimeKind.Local).AddTicks(2180)
                        },
                        new
                        {
                            Id = 2,
                            CashierId = 2,
                            PaidOnDate = new DateTime(2025, 2, 3, 11, 16, 38, 76, DateTimeKind.Local).AddTicks(2236)
                        });
                });
